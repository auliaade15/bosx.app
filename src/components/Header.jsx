...
export default function Header() {
  ...
  return (
    <header className="w-full flex items-center justify-between px-4 py-2 bg-white shadow-sm relative z-30">
      {/* Search */}
      <div className="flex items-center w-1/3 bg-red-50 rounded-md px-3 py-2">
        <input
          type="text"
          placeholder="Search"
          className="flex-1 bg-transparent outline-none text-sm text-red-700 placeholder-red-400"
        />
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          {openProfile && (
            <div className="absolute right-0 mt-2 w-40 bg-white border border-red-100 shadow-lg rounded-md py-2 z-50">
              <Link
                to="/profile"

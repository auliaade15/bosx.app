...
export default function HitungGajiForm() {
  ...
  return (
    <Card judul="Hitung Gaji Bersih">
      ...
      {!gaji ? (
        <Alert pesan="Silahkan masukkan gaji yang valid (tidak boleh kosong atau negatif)." type="eror" />
      ) : (
        <Alert pesan={`Total Take Home Pay (THP): Rp ${totalGaji.toLocaleString()}`} type="success" />
      )}
    </Card>
  );
}